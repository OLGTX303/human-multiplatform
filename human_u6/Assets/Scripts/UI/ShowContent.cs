...
namespace OLGTX.UI 
{
    public sealed class ShowContent : MonoBehaviour
    {
        ...
        /// <summary>
        /// Size the bubble NOW (same math as LateUpdate) — called before this
        /// bubble is frozen so its final height is correct even when all its
        /// text arrived this frame (one-shot ASR/short replies).
        /// </summary>
