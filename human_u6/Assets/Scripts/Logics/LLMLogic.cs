...
namespace OLGTX.Logics
{
    ...
    public sealed class LLMLogic
    {
        ...
        {
            // emotion cue from the sentence content (fallback when the LLM
            // sends no <control> block) — mirrors the web pipeline
            OLGTX.Rolle.RolleManager.Instance?.CueSentence(text);
